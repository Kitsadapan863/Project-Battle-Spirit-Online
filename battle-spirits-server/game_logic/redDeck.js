...
module.exports.redCards = [
    ...
    {
        id: 'magic-lightning-aura',
        name: 'Lightning Aura',
        quantity: 1,
        image: `${pathsMagic}/Lightning Aura.webp`,
        cost: 4,
        symbol_cost: { "red": 2 },
        type: 'Magic',
        color: 'red',
        effects: [
            { timing: 'flash', keyword: 'clash_attacks', power: 1000, condition:['clash'], power_add:2000 , duration: 'turn',
                description: '[Flash]\nAttacking spirits you control without [Clash] get +1000BP until end of turn and those with Rage get +3000BP until end of turn.' },
        ],
    },
    {
